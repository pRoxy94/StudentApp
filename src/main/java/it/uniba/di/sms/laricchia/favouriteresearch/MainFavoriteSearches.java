package it.uniba.di.sms.laricchia.favouriteresearch;
...
public class MainFavoriteSearches extends AppCompatActivity {
    ...
    public View.OnClickListener clearTagsButtonListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(MainFavoriteSearches.this);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_fts); // set the layout
